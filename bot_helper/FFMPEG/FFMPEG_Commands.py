...
# START OF MODIFIED BLOCK
            ...
            if apply_user_metadata_globally:
                ...
                command.extend(['-metadata:s:v', f'Credit={user_global_metadata_text}'])
                command.extend(['-metadata:s:v', f'channel={user_global_metadata_text}'])
...
# START OF MODIFIED BLOCK
            ...
            if apply_user_metadata_convert:
                ...
                if user_global_metadata_text_convert: # Only if text is not empty
                    ...
                    command.extend(['-metadata', f'Credit={user_global_metadata_text_convert}'])
                    command.extend(['-metadata', f'channel={user_global_metadata_text_convert}'])
                    ...
                    command.extend(['-metadata:s:v:0', f'Credit={user_global_metadata_text_convert}'])
                    command.extend(['-metadata:s:v:0', f'channel={user_global_metadata_text_convert}'])
                    command.extend(['-metadata:s:a', f'Credit={user_global_metadata_text_convert}'])
                    if convert_copysub: # Apply to subtitle titles only if copying subtitles
                        command.extend(['-metadata:s:s', f'Credit={user_global_metadata_text_convert}'])
...
# START OF MODIFIED BLOCK
        ...
        if apply_user_metadata_cmd:
            ...
            if user_global_metadata_text_cmd:
                ...
                command.extend(['-metadata', f'Credit={user_global_metadata_text_cmd}'])
                command.extend(['-metadata', f'channel={user_global_metadata_text_cmd}'])
            command.extend(['-metadata', 'encoded_by=[ BashAFK ~ TG_Eliteflix_Official ]'])
            command.extend(['-metadata', 'description=Visit TG-@Eliteflix_Official'])
            command.extend(['-metadata', 'telegram=Downloaded From @Eliteflix_Official'])
            command.extend(['-metadata', 'WEBSITE=https://t.me/Eliteflix_Official'])
...
# START OF MODIFIED BLOCK
        if apply_user_metadata_ci:
            ...
            if user_global_metadata_text_ci:
                ...
                command.extend(['-metadata', f'Credit={user_global_metadata_text_ci}'])
                command.extend(['-metadata', f'channel={user_global_metadata_text_ci}'])
            command.extend(['-metadata', 'encoded_by=[ BashAFK ~ TG_Eliteflix_Official ]'])
            command.extend(['-metadata', 'description=Visit TG-@Eliteflix_Official'])
            command.extend(['-metadata', 'telegram=Downloaded From @Eliteflix_Official'])
            command.extend(['-metadata', 'WEBSITE=https://t.me/Eliteflix_Official'])
